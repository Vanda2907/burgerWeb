  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
        sticky ? "bg-base-300 shadow-md transition" : ""
      }`}
    >
      <div className="navbar justify-between items-center py-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:block">
            <label className="px-3 py-2 border-1 rounded-3xl flex items-center">
              <input
                type="search"
                className="grow outline-none p-1"
          ...
          {/* Mobile Swap Toggle - Always Visible */}
