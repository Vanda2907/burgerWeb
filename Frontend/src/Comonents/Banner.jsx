        ...
        <div className="max-w-screen-2xl container mx-auto md:px-20 m-10 px-4 flex flex-col md:flex-row pt-20 gap-8 items-center">
          ...
          <div className="carousel rounded-3xl w-full max-w-xs md:max-w-md overflow-hidden shadow-lg">
            <div id="slide1" className="carousel-item relative w-full">
              ...
              <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
                <a
                  href="#slide2"
                  className="btn btn-circle border-none bg-amber-500 text-white hover:scale-110"
                >
                  ❯
                </a>
              </div>
          ...
          <div className="w-full md:w-1/2 px-2 ">
            ...
            <p className="text-base text-justify py-4">
              A burger is more than just a meal — it’s an experience. With
              layers of juicy, flame-grilled patties, fresh veggies, melted
              cheese, and signature sauces tucked between soft, toasted buns,
              burgers bring together bold flavors in every bite. Whether you
              crave classic simplicity or love gourmet toppings, burgers offer
